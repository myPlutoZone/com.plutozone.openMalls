 ...
 *				: [20240626132804][pluto#plutozone.com][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Controller("com.plutozone.front.center.controller.CenterWeb")
public class CenterWeb extends Common {
	 ...
	 * <p>EXAMPLE:</p>
	 */
	@RequestMapping(value = "/front/center/index.web")
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
		
		ModelAndView mav = new ModelAndView("redirect:/error.web");
		
		try {
			mav.setViewName("front/center/index");
		}
		catch (Exception e) {
