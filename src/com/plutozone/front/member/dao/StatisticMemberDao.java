 ...
 *				: [20240813155802][pluto#plutozone.com][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Repository("com.plutozone.front.member.dao.StatisticMemberDao")
public class StatisticMemberDao extends BaseDao {
	
	public int insert(StatisticMemberDto statisticMemberDto) {
		return sqlSessionFront.insert("com.plutozone.front.mybatis.member.StatisticMember.insert", statisticMemberDto); 
	}
}
