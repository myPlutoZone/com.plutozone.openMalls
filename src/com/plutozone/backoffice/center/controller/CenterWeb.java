 ...
 *				: [20240730145041][pluto#plutozone.com][CREATE: Initial Release]
 */
 ...
 * <p>IMPORTANT:</p>
 */
@Controller("com.plutozone.backoffice.center.controller.CenterWeb")
public class CenterWeb extends Common {
	 ...
	 * <p>EXAMPLE:</p>
	 */
	@RequestMapping(value = "/console/center/index.web")
	public ModelAndView index(HttpServletRequest request, HttpServletResponse response) {
		
		ModelAndView mav = new ModelAndView("redirect:/error.web");
		
		try {
			mav.setViewName("backoffice/center/index");
		}
		catch (Exception e) {
