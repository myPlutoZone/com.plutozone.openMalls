 ...
 *				: [20240828144401][pluto#plutozone.com][CREATE: Initial Release]
 */
...
import com.plutozone.backoffice.users.dao.SellerDao;
 ...
 * <p>IMPORTANT:</p>
 */
@Service("com.plutozone.backoffice.users.service.SellerSrvc")
public class SellerSrvc {
	...
	public PagingListDto list(PagingDto pagingDto) {
		...
		// 전체 라인(행) 수
		int totalLine = sellerDao.count(pagingDto);
		...
		pagingListDto.setList(sellerDao.list(pagingDto));
