 ...
 *				: [20240726160000][pluto#plutozone.com][CREATE: Initial Release]
 */
%>
	...
	<section class="content">
		...
		<article class="txtCenter">
			<table class="headLeft_01" style="width: 320px; margin-left: auto; margin-right: auto">
				<tr>
					<th>아이디</th>
					<td><input autofocus type="text" id="id" name="id" value="administrator" maxlength="16" required onKeyPress="if (event.keyCode == 13) checkForm();"/></td>
				</tr>
				<tr>
					<th>비밀번호</th>
