				...
				$.ajax({
					...
					success:function(res) {
						...
						if (res) {
							...
							if (jsonData.email != "") {
								// [2024-07-25][pluto#plutozone.com][TODO-개선: 관리자 상태 확인 포함]
		...
		<article class="txtCenter">
			...
			<table class="headLeft_01" style="width: 900px; margin-left: auto; margin-right: auto">
				<tr>
					...
					<td>
						<input value="administrator" type="text" id="id" name="id" required />
				...
				<tr>
					<th>성명(*)</th>
					<td>
						<input value="홍길동" type="text" id="mng_nm" name="mng_nm" required />
					</td>
				</tr>
				<tr>
					<th>이메일(*)</th>
					<td>
						<input value="pluto#plutozone.com" type="text" id="email" name="email" required />
					</td>
				</tr>
				<tr>
					<th>연락처(*)</th>
